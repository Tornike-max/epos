    ...
    <div className="w-full flex flex-col justify-center items-start gap-4">
      <div className="w-full flex items-center justify-start  gap-4">
        ...
        <div className="max-w-[500px] w-full flex flex-col items-start justify-start">
          <h3 className="text-slate-700 text-lg sm:text-2xl font-semibold pb-2">
            {productData.title}
          </h3>
          <p className="text-gray-600 w-full flex items-center gap-4">
          ...
          <div className="flex items-center justify-start mt-2 gap-4">
            ...
            <p className="text-sm text-gray-500">For: {productData?.for}</p>
          </div>
      ...
      <div className="w-full flex items-start justify-center flex-col gap-4 py-4">
        <h3 className="w-full text-start text-slate-800 font-semibold text-xl sm:text-2xl">
          Product Summary
        </h3>
        <p className="max-w-[700px] w-full text-start text-slate-600 font-medium text-base sm:text-lg">
